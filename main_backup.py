...
## main_backup.py, sekarang nak refactor, in case apa2 terjadi, boleh rujuk code asal
...
def show_menu():
    ...
    print("1. Analyse New Match")
    print("2. View History")
    print("3. Update Reflection")
...
#     print("3. Update Reflection Note")
#     print("4. Delete Analysis")
#     print("5. Exit")
...
# player =_hero # data = get_match(match_id)
